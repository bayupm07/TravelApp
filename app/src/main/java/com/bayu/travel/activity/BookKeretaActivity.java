package com.bayu.travel.activity;
...
import com.bayu.travel.R;
import com.bayu.travel.database.DatabaseHelper;
import com.bayu.travel.session.SessionManager;
...
public class BookKeretaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] asal = {"Padang", "Pariaman", "Padang Panjang"};
        final String[] tujuan = {"Padang", "Pariaman", "Padang Panjang"};
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sAsal != null && sTujuan != null && sTanggal != null && sDewasa != null) {
                    if ((sAsal.equalsIgnoreCase("padang") && sTujuan.equalsIgnoreCase("padang"))
                            || (sAsal.equalsIgnoreCase("pariaman") && sTujuan.equalsIgnoreCase("pariaman"))
                            || (sAsal.equalsIgnoreCase("padang panjang") && sTujuan.equalsIgnoreCase("padang panjang"))) {
    ...
    public void perhitunganHarga() {
        if (sAsal.equalsIgnoreCase("padang") && sTujuan.equalsIgnoreCase("padang panjang")) {
            hargaDewasa = 50000;
            hargaAnak = 30000;
        } else if (sAsal.equalsIgnoreCase("padang") && sTujuan.equalsIgnoreCase("pariaman")) {
            hargaDewasa = 30000;
            hargaAnak = 15000;
        } else if (sAsal.equalsIgnoreCase("padang panjang") && sTujuan.equalsIgnoreCase("pariaman")) {
            hargaDewasa = 20000;
            hargaAnak = 15000;
        } else if (sAsal.equalsIgnoreCase("padang panjang") && sTujuan.equalsIgnoreCase("padang")) {
            hargaDewasa = 50000;
            hargaAnak = 30000;
        } else if (sAsal.equalsIgnoreCase("pariaman") && sTujuan.equalsIgnoreCase("padang panjang")) {
            hargaDewasa = 20000;
            hargaAnak = 15000;
        } else if (sAsal.equalsIgnoreCase("pariaman") && sTujuan.equalsIgnoreCase("padang")) {
            hargaDewasa = 30000;
            hargaAnak = 15000;
        }
